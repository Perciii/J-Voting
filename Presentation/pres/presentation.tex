...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Si variable réfère à un type primitif (\texttt{int}, \texttt{double}, …) : valeur dans sa case mémoire
		\item Si variable réfère à un type objet : valeur est une référence vers un objet (sur le tas)
