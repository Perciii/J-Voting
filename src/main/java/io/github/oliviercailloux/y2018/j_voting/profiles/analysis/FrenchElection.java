...
/**
 * 
 *This class provides the result of an election, given by the french election system. This means that each voter can only vote for one alternative. This class can provide a result only for strict profiles.
 *
 */
public class FrenchElection implements SocialWelfareFunction{
	...
	public Preference getSocietyPreference(ImmutableProfileI profile) {
		...
		ImmutableStrictProfileI newProf = new StrictProfileBuilder((StrictProfileI)profile).createOneAlternativeProfile();
